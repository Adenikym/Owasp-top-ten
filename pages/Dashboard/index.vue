  ...
  data() {
    return {
      headers: [
        ...
        { text: "Description", value: "description", width: "30%", align:"start" },
        { text: "Number of Occurences", value: "occurences", align:"start" },
        { text: "Max coverage(%)", value: "maxCoverage", align:"start" },
